	...
	data: [
		{
			...
			icon: 'Paw',
			heroBannerCreadits:
				'Photo by [Evan Clark](https://unsplash.com/@iamevanclark?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/stray?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)',
