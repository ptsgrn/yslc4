<script>
	...
	let donor = {
		...
		recipient: 'ช้าง',
		requester: 'อินเตอร์เน็ต',
		end: new Date().setFullYear(2023),
		goal: 20_000,
		heroImage: {
			thumbnail: {
		...
		donatMoney: [
			{
				accountName: 'บัญชีนาง1',
				accountID: '32123123123',
				bank: 'ธนชาตื'
			},
			{
				accountName: 'บัญชีนาย2',
				accountID: '82123123123',
				bank: 'กรุงไทย'
			}
		],
		campaignSource: '[อินเตอร์เน็ต](https://fb.me/)'
	};
</script>
